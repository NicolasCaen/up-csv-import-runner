...
## Changelog
- 2025-11-12 · v0.1.2.1 · Fusion des sources de configurations (local, dossier personnalisé relatif à `wp-content/`, dossier Importer) et aperçu diagnostic (chemin XML + liste des champs) sur la page d’import.
